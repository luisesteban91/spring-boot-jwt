...
@Secured("ROLE_ADMIN") //Habilitar la seguridade del role a todos los metodos del controlador
@Controller
...
public class FacturaController {
	...
	public String guardar(
			/* @Valid habilitar la validacion en el objeto factura*/
			@Valid Factura factura,
			/*BindingResult para comprobar si ubo errores*/
